            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right">
                        <a href="/home/accounts/add-account" class="btn btn-outline-primary btn-sm"><i class="mdi mdi-account-plus"></i> Add Account</a>
                    </div>
                </div>
                                        ...
                                        <td style="text-align: right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton3">
                                                    <a class="dropdown-item" href="/home/accounts/edit-account/?accountId=${account.id}">
                                                        Edit
                                                    </a>
                                                    <form action="/home/accounts/${account.id}" method="post">
