...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Add Doctor Schedule</h4>
            <form:form method="post" modelAttribute="adddoctorschedule" cssClass="form-sample">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <form:select cssClass="form-control" path="doctor" id="doctor">
                    ...
                    <div class="col-sm-12 text-right">
                        <button type="submit" class="btn btn-outline-primary">
                            <div class="row">
                                ...
                                <div class="col-sm-9"><strong> Create Doctor Schedule</strong></div>
                            </div>
                        </button>
                    </div>
                </div>
